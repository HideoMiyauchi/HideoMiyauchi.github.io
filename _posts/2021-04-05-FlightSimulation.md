...
author: Hideo Miyauchi
date: 2021-04-06 00:00:00 +0900
categories: [Simulation, Flight]
tags: [FlightSimulation]
math: true
mermaid: true
image:
  src: /assets/img/20210405/flight.jpg
---
...
表示する機体は下手なワイヤーフレームなので分かりにくいのですが、尾翼位置が赤いライン、車輪位置が青いラインと思って見てください。

<!--*****************************************************-->
## さいごに
映画「インデペンデンス・デイ」のラストで爆弾ごと突っ込む老パイロットの操縦を見ると
操縦桿１本で簡単に操縦できそうに思えましたが、
コンピュータ制御無しの機体は横滑りの修正、長・短周期振動の抑制などの操舵も必要で
あることが分かりました。
<br>
